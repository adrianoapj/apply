...
class IndexPage extends Component {
  ...
  createNewApplication = (firstTime = false) => {
    const msg = this.props.intl.formatMessage({id: "REPLACE_CURRENT_APPLICATION_WARNING"})
        ...
        return (
          <Full>
            ...
            >
              ...
              {intl.formatMessage({id: "WELCOME_WE_CANT_WAIT_TO_SEE_MESSAGE"})}
                <br />
                {intl.formatMessage({id: "WELCOME_LETS_GET_YOU_SIGNED_IN_MESSAGE"})}
              </Text>
              <LoginForm
                bg="black"
                color="white"
  ...
  render() {
    return (
      <Layout>
        <Helmet title={this.props.intl.formatMessage({id: "INITIAL_PAGE_TITLE"})} />
        {this.content()}
      </Layout>
    )
  }
