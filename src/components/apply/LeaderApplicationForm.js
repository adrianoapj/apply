  ...
  return (
    <Form onSubmit={handleSubmit}>
      <Fieldset section={intl.formatMessage({id: "LEADER_ROUTE"})}>
        <Field {...field('leader_name')} label={intl.formatMessage({id: "LEADER_FULL_NAME_LABEL"})} />
        <Field {...field('leader_birthday')} label={intl.formatMessage({id: "LEADER_BIRTHDAY_LABEL"})} type="date" />
        <Field
        ...
        >
          ...
          <option value="freshman">{intl.formatMessage({id: "FRESHMAN"})}</option>
          <option value="sophomore">{intl.formatMessage({id: "SOPHOMORE"})}</option>
          <option value="junior">{intl.formatMessage({id: "JUNIOR"})}</option>
          <option value="senior">{intl.formatMessage({id: "SENIOR"})}</option>
          <option value="other_year">{intl.formatMessage({id: "OTHER_YEAR"})}</option>
        </Field>
        <Field
      ...
      <Fieldset section={intl.formatMessage({id: "STATS"})}>
        ...
        <Field {...field('leader_gender')} label={intl.formatMessage({id: "GENDER"})} type="select">
          <option value="" disabled>
            {intl.formatMessage({id: "SELECT_ONE"})}
          </option>
          <option value="male">{intl.formatMessage({id: "MALE"})}</option>
          <option value="female">{intl.formatMessage({id: "FEMALE"})}</option>
          <option value="genderqueer">{intl.formatMessage({id: "GENDERQUEER"})}</option>
          <option value="agender">{intl.formatMessage({id: "AGENDER"})}</option>
          <option value="other_gender">{intl.formatMessage({id: "OTHER"})}</option>
        </Field>
        <Field {...field('leader_ethnicity')} label={intl.formatMessage({id: "ETHNICITY"})} type="select">
          <option value="" disabled>
            {intl.formatMessage({id: "SELECT_ONE"})}
          </option>
          <option value="hispanic_or_latino">{intl.formatMessage({id: "HISPANIC_OR_LATINO"})}</option>
          ...
          <option value="other_ethnicity">{intl.formatMessage({id: "OTHER_ETHNICITY"})}</option>
        </Field>
      </Fieldset>
      ...
      <Fieldset section={intl.formatMessage({id: "SKILLS"})}>
        ...
        <Field
          ...
          label={intl.formatMessage({id: "SKILLS_IMPRESSIVE_ACHIEVEMENT_LABEL"})}
          type="textarea"
          min="100"
          max="250"
        />
