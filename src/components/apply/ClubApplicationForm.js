  ...
  return (
    <Form onSubmit={handleSubmit}>
      <Fieldset section={intl.formatMessage({id: "SCHOOL"})}>
        <Field {...field('high_school_name')} label={intl.formatMessage({id: "HIGH_SCHOOL_NAME_LABEL"})}/>
        <Field
        ...
        >
          ...
          <option value="public_school">{intl.formatMessage({id: "PUBLIC_SCHOOL"})}</option>
          <option value="private_school">{intl.formatMessage({id: "PRIVATE_SCHOOL"})}</option>
          <option value="charter_school">{intl.formatMessage({id: "CHARTER_SCHOOL"})}</option>
        </Field>
        <Field
      ...
      <Fieldset section={intl.formatMessage({id: "FORMATION"})}>
        ...
        <Field
          ...
          label={intl.formatMessage({id: "OTHER_RELEVANT_INFO_ABOUT_SCHOOL_RELATIONSHIP_LABEL"})}
          type="textarea"
          optional
        />
      </Fieldset>
      <Fieldset section={intl.formatMessage({id: "OTHER_SECTION"})}>
        <Field
          ...
          label={intl.formatMessage({id: "SOMETHING_SURPRISING_YOU_LEARNED_LABEL"})}
          hint={intl.formatMessage({id: "SOMETHING_SURPRISING_YOU_LEARNED_HINT"})}
          type="textarea"
          min="50"
          max="400"
        />
